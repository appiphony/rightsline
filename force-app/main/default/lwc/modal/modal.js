...
export default class Modal extends LightningElement {
    ...
    get modalClass() {
        return (
            ...
            (this.variant === 'error' || this.variant === 'warning'
                ? ' slds-modal_prompt'
                : '') +
            (this.large ? ' slds-modal_large' : '') +
            (this.medium ? ' slds-modal_medium' : '') +
            (this.small ? ' slds-modal_small' : '') +
            (this.showModal ? ' slds-fade-in-open' : ' sm-pointer-events_none')
        );
    }
    ...
    get backdropClass() {
        return (
            'slds-backdrop' +
            (this.showModal ? ' slds-backdrop_open' : ' sm-pointer-events_none')
        );
    }
    ...
    get modalHeaderClass() {
        return (
            'slds-modal__header' +
            (this.hideHeader ? ' slds-modal__header_empty' : '') +
            (this.variant === 'error' || this.variant === 'warning'
                ? ' slds-theme_alert-texture slds-theme_' + this.variant
                : '')
        );
    }
    ...
    get modalContentClass() {
        return (
            'slds-modal__content slds-p-around_' +
            this.contentPadding +
            (this.overflowVisible ? ' slds-expanded' : '')
        );
    }
